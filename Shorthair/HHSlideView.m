...
- (void)addButtons {
    ...
    for (NSInteger number=0; number < numberOfItems; number++) {
        ...
        if (number == 0) {
            ...
            [(UIButton *)[_buttonsArray objectAtIndex:number] setTitleColor:[UIColor colorWithRed:200/255.0 green:242/255.0 blue:235/255.0 alpha:1.0] forState:UIControlStateNormal];
        }
    }
}
